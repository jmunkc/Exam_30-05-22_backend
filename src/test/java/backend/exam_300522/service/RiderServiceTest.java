...
class RiderServiceTest {
    ...
    void setUp() {
        ...
        Team movie = new Team(new TeamRequest("Moviestar Team"));

        teamRepository.save(cofidis);
        teamRepository.save(lottoSoudal);
        teamRepository.save(movie);
        ...
        Rider l1 = new Rider("Pirre-Luc", "Perichon", LocalDate.of(1933,03,10), "France", lottoSoudal);
    ...
    void addRiderTest() {
        Team cofidis = new Team(new TeamRequest("Cofidis"));
        RiderRequest newRider = new RiderRequest("John", "Johnson", "1956-11-25", "Germany", cofidis.getTeamName());
